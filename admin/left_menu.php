	...
	<div class="viewport">
		<div class="overview"> 
			...
			<div class="menubox">
				...
				<a href="infoimg.php" target="main">资源下载管理</a>
				<a href="infolist.php" target="main">最新资讯管理</a>
				<a href="nav.php" target="main">导航菜单设置</a> 
				<a href="imgtext.php" target="main">图文替换管理</a> 
				<a href="member.php" target="main">会员管理</a> 
				 </div>
			</div>
			<!--scrollbar end--> 
		</div>
...
<div class="copyright"> © 2017 <a href="http://www.ymypt.com/" target="_blank">智云智源码下载</a><br />
