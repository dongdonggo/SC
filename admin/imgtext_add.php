...
<body>
<div class="formHeader"> <span class="title">单图文固定信息</span> <a href="javascript:location.reload();" class="reload">刷新</a> </div>
<form name="form" id="form" method="post" action="imgtext_save.php">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		...
		?>
		<tr>
			<td height="40" align="right">位置说明：</td>
			<td><input type="text" name="title" id="title" class="input" />
			</td>
		</tr>
			<tr>
			<td height="40" align="right">主标题：</td>
			<td><input type="text" name="title1" id="title1" class="input" />
			</td>
		</tr>
		<td height="40" align="right">副标题：</td>
			...
			<td><input type="text" name="title3" id="title3" class="input" />
			</td>
		</tr>
		...
		<tr>
			...
			<td><input type="text" name="bz" id="bz" class="input" /></td>
			</tr>
