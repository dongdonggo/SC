...
<div class="loginTop" <?php //echo GetLoginBg(); ?>>
	<div class="logo"><a href="http://www.ymypt.com" target="_blank"><img src="templates/images/logo.png"></a></div>
	<div class="text"><span class="note">
		<?php if(strstr(GetCurUrl(), '/admin/login')) echo '提示：您的后台路径为/<i>admin</i>/，建议更改为更加安全的路径！'; ?>
		</span>
		
		<p class="p1">技术支持：18718670193</p>
		<p class="p2">官方网站： <a href="http://www.ymypt.com/" target="_blank" class="link">www.ymypt.com</a></p></div>
</div>
<div class="clear"></div>
...
<div class="clear"></div>
<div class="loginCopyright">Copyright © 2008 - 2014 深圳一号设计 All Rights Reserved 源码云平台出品 顶级源码交易市场</div>
</body>
</html>