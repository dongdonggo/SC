	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		...
		<tr>
			...
			<td width="75%"><select name="is_hy" id="is_hy">
					<option <?php if ($row['is_hy']==-1){ ?>selected="selected"<?php } ?> value="-1">请选择会员下载权限</option>
					<option <?php if ($row['is_hy']==0){ ?>selected="selected"<?php } ?> value="0">普通会员</option>
					<option <?php if ($row['is_hy']==1){ ?>selected="selected"<?php } ?> value="1">初级会员</option>
					<option <?php if ($row['is_hy']==2){ ?>selected="selected"<?php } ?> value="2">高级会员</option>
					<option <?php if ($row['is_hy']==3){ ?>selected="selected"<?php } ?> value="3">终身会员</option>
				</select>
				</td>
		</tr>
		<?php
		...
		<tr>
			...
			<td><input type="text" name="source" id="source" class="input" value="<?php echo $row['source']; ?>" />
				<span style="display:none" class="srcArea"> <span class="infosrc">选择
				<ul>
					<?php
		...
		<tr>
			...
			<td><p>
			  <label>
			    <input name="is_hot" id="is_hot" type="radio" value="0" <?php if ($row['is_hot']==0){ ?>checked="checked"<?php } ?> />
			    普通资源</label>
			  
			  <label>
			    <input type="radio" name="is_hot" value="1" <?php if ($row['is_hot']==1){ ?>checked="checked"<?php } ?> />
		...
		<tr>
			...
			<td><input type="text" name="taobaolj" id="taobaolj" class="input" value="<?php echo $row['taobaolj']; ?>" /> </td>
		</tr>
		<tr>
